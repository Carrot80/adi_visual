...
%    end
 ...
 save([path2Cdrive subjectdir(ii).name filesep pathname 'permutation_distribution_0.03_0.15.mat'], 'perf_perm')
...
for ff = 1:length(session.label)
    ...
    clabel_train_fold_rand = zeros(size_random_dataset, length(clabel_train_fold), 'gpuArray');
