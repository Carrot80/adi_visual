...
%         if ~exist([mainpath subjectdir(ii).name filesep filename  '_' num2str(comp(pp, 1)) '_' num2str(comp(pp, 2)) '_ms_lda.fig'], 'file')
        ...
        %     perf.config.methods = 'bootstrap_pseudotrials';
            ...
            save([mainpath subjectdir(ii).name filesep filename 'perf_pseudotrials_equalnum_x2_trainfold_only_' num2str(time_interval(1)) '_' num2str(time_interval(2)) 'ms_svm.mat'], 'perf')
